...
public sealed class ErrorsRepository : BaseEntityFrameworkRepository<ErrorEntity>, IErrorsRepository
{
    public ErrorsRepository(IOptions<EntityFrameworkRepositoryOptions> options) : base(options)
    {
    }
}
