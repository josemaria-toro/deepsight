...
public sealed class PageViewsRepository : BaseEntityFrameworkRepository<PageViewEntity>, IPageViewsRepository
{
    public PageViewsRepository(IOptions<EntityFrameworkRepositoryOptions> options) : base(options)
    {
    }
}